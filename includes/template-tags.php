...
if ( ! function_exists( 'herringbone_posted_on' ) ) :
	/**
	 * Prints HTML with meta information for the current post-date/time.
	 */
	function herringbone_posted_on() {
		...
		$posted_on = sprintf(
			...
			esc_html_x( 'Posted on %s', 'post date', 'herringbone' ),
...
if ( ! function_exists( 'herringbone_posted_by' ) ) :
	/**
	 * Prints HTML with meta information for the current author.
	 */
	function herringbone_posted_by() {
		$byline = sprintf(
...
if ( ! function_exists( 'herringbone_entry_footer' ) ) :
	/**
			...
			comments_popup_link(
				sprintf(
					wp_kses(
						...
						__( 'Leave a Comment<span class="screen-reader-text"> on %s</span>', 'herringbone' ),
						array(
							'span' => array(
								'class' => array(),
							),
		...
		edit_post_link(
			sprintf(
				wp_kses(
					...
					__( 'Edit <span class="screen-reader-text">%s</span>', 'herringbone' ),
					array(
						'span' => array(
							'class' => array(),
						),
...
if ( ! function_exists( 'herringbone_post_thumbnail' ) ) :
	/**
